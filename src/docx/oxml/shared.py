...
class CT_DecimalNumber(BaseOxmlElement):
    ...
    val: int = RequiredAttribute("w:val", ST_DecimalNumber)  # ty: ignore[invalid-assignment]
...
class CT_OnOff(BaseOxmlElement):
    ...
    val: bool = OptionalAttribute(  # ty: ignore[invalid-assignment]
...
class CT_String(BaseOxmlElement):
    ...
    val: str = RequiredAttribute("w:val", ST_String)  # ty: ignore[invalid-assignment]
